 ...
 */
public class RtspTeardownAction implements RtspAction {
	 ...
	 * 
	 */
	public RtspTeardownAction(MainFrame ui, CoshipClientSupport client) {
	...
	public int execute(RtspSession session, RtspMessage msg) {
		...
		ui.log("TEARDOWN : " + resp.getDescription() + "\n");
