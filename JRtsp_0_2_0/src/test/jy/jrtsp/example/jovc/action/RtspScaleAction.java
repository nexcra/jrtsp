 ...
 */
public class RtspScaleAction implements RtspAction {
	 ...
	 * 
	 */
	public RtspScaleAction(MainFrame ui, CoshipClientSupport client) {
	...
	public int execute(RtspSession session, RtspMessage msg) {
		...
		ui.log("SCALE : " + resp.getDescription() + "\n");
		if (resp.getStatus().equals("200")) {
			ui.showButton(true, true, true, true, true);
		} else {
