 ...
 */
public class RtspGetParameterAction extends RtspAction {
	 ...
	 * 
	 */
	public RtspGetParameterAction(MainFrame ui, CoshipClientSupport client) {
	...
	public void execute(RtspMessage msg) {
		...
		ui.log("GET_PARAMETER : " + resp.GetDescribe() + "\n");
