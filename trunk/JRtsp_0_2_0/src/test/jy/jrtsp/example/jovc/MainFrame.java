...
public class MainFrame extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1591847463369831651L;
    ...
    public void setSession(RtspSession session) {
    ...
    public void playBtn_actionPerformed(ActionEvent e) {
    	...
    	if (! this.stopBtn.isEnabled()) {
	    	try {
	    		...
	    		InetSocketAddress address = new InetSocketAddress((String)clientBox.getSelectedItem(), Integer.parseInt((String)clientPortBox.getSelectedItem()));
	    		client.connect(context, address);
    ...
    public void aboutBtn_actionPerformed(ActionEvent e) {
        JOptionPane.showMessageDialog(this,
                                      "JOVC 0.12.0\n"+
                                      "\tCopyright (c) Jiang Ying 2007 - 2008\n" + 
                                      "\tjy@iptv.com.ru");
    }
